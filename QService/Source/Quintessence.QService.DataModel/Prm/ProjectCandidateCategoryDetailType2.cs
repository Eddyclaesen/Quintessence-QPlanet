...
{
    public class ProjectCandidateCategoryDetailType2 : EntityBase, IProjectCandidateCategoryDetailType, IInvoiceInfo
    {
        public Guid ProjectCandidateId { get; set; }
        public Guid ProjectCategoryDetailType2Id { get; set; }
