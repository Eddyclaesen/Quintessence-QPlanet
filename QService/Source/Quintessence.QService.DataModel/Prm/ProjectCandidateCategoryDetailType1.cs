...
{
    public class ProjectCandidateCategoryDetailType1 : EntityBase, IProjectCandidateCategoryDetailType, IInvoiceInfo
    {
        public Guid ProjectCandidateId { get; set; }
        public Guid ProjectCategoryDetailType1Id { get; set; }
