...
/*Theorem list request templates*/
...
IF NOT EXISTS(SELECT * FROM [TheoremListTemplate] WHERE [Code] LIKE 'EMPLOYEE')
BEGIN
INSERT INTO TheoremListTemplate (Id, Name, Code, Audit_CreatedBy, Audit_CreatedOn, Audit_IsDeleted, Audit_VersionId) VALUES (@DefaultTheoremListTemplateId, 'Template for employees', 'EMPLOYEE', @SystemUser, GETDATE(), 0,NEWID())
...
IF NOT EXISTS(SELECT * FROM [TheoremListTemplate] WHERE Code LIKE 'COMPANY')
BEGIN
INSERT INTO TheoremListTemplate (Id, Name, Code, Audit_CreatedBy, Audit_CreatedOn, Audit_IsDeleted, Audit_VersionId) VALUES (@DefaultTheoremListTemplateId, 'Template for companies', 'COMPANY', @SystemUser, GETDATE(), 0,NEWID())
