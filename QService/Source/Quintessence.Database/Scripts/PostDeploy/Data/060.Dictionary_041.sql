...
INSERT INTO @DictionaryTable
	...
	where w_samengesteld.woordenboek_id = 41
...
SELECT @ContactId = contact_id FROM [$(ActServer)].[$(Act)].[dbo].woordenboek where woordenboek_id = 41
...
INSERT INTO [Dictionary]([Id], [ContactId], [Name], [Description], [Current], [LegacyId])
	...
	WHERE ActDictionary.[Woordenboek_id] = 41
