...
{
    public class BusinessTestConfiguration : IConfiguration
    {
        private readonly Dictionary<Type, string> _connectionStringConfigurations = new Dictionary<Type, string>();

        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessTestConfiguration" /> class.
        /// </summary>
        public BusinessTestConfiguration()
        {
            ...
            Trace.WriteLine(string.Format("Save '{0}' as connection string configuration name.", qDataTestContext));
