...
{
    public class StandardScoresSimulationCombinationModel
    {
        private List<EditProjectCandidateCompetenceSimulationScoreModel> _competences;
        ...
        public List<EditProjectCandidateCompetenceSimulationScoreModel> Competences
        {
            get { return _competences ?? (_competences = new List<EditProjectCandidateCompetenceSimulationScoreModel>()); }
