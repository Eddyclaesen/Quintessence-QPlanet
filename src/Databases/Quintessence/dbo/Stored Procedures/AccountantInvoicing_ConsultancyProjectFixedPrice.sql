...
CREATE PROCEDURE [dbo].[AccountantInvoicing_ConsultancyProjectFixedPrice]
	@Date	DATETIME = NULL,
...
BEGIN
	...
	WHERE		(@Date IS NULL OR ISNULL([ProjectFixedPriceView].InvoicedDate, [ProjectFixedPriceView].Deadline) <= @Date)
