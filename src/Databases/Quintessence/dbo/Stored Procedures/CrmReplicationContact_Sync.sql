...
BEGIN
	...
	INSERT INTO @Contact(	[Id],
		...
		FROM        [Superoffice7].[CRM7].CONTACT AS CONTACT_1 
		LEFT JOIN	[Superoffice7].[CRM7].UDCONTACTSMALL AS cs 
			ON		cs.udcontactSmall_id = CONTACT_1.userdef_id
		LEFT JOIN	[Superoffice7].[dbo].vw_Klanten_ptool AS ka 
