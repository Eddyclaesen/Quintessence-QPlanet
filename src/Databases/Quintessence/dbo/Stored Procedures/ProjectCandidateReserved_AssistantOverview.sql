...
BEGIN
	...
	SELECT		NEWID()																				AS  [Id],							
				...
				CASE WHEN [CrmAppointmentView].[LastName] is null THEN ' ('+SoTask.Description COLLATE Latin1_General_CI_AI+')'
				ELSE [CrmAppointmentView].[LastName]+' ('+SoTask.Description COLLATE Latin1_General_CI_AI+')'
				END
	...
	LEFT JOIN	CrmReplicationAppointmentTaskMapping SoTask
		ON		[CrmAppointmentView].TaskId = SoTask.TaskId
